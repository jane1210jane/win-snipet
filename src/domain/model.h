...
struct AppSettings { unsigned schemaVersion{1}; bool startupEnabled{true}; bool firstRunCompleted{false}; Hotkey pickerHotkey{{Modifier::Alt}, L'P'}; std::vector<Snippet> snippets; };
...
[[nodiscard]] std::wstring FormatPickerItem(const Snippet& snippet);
